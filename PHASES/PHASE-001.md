...
- [ ] Task 1.4: Install core dependencies: `zustand`, `axios`, `react-leaflet`, `leaflet`, `recharts`, `react-icons`, `sass`
...
- [ ] Task 3.1: Create API service layer with Axios instance and base configuration
...
2. **Install Dependencies**: Navigate to project and run `npm install zustand axios react-leaflet leaflet recharts react-icons sass` for core dependencies
...
1. **Service Layer**: Create `src/services/api.ts` with Axios instance configured for REST Countries API (<https://restcountries.com/v4>)
...
- **External**: Next.js 16, React 18, TypeScript 5, Leaflet, Recharts, React Icons, Zustand, Axios
